...
time_bucket = {
    "00s_05s" : Interval(0, 5 * 1e3, upper_closed=False),
    "05s_20s": Interval(5 * 1e3, 20 * 1e3, upper_closed=False),
    "20s_2M" : Interval(20 * 1e3, 2 * 60 * 1e3, upper_closed=False),
    "2M_20M": Interval(2 * 60 * 1e3, 20 * 60 * 1e3, upper_closed=False),
    "20M_N" : Interval(20 * 60 * 1e3, np.inf),}
